...
def validatePassword(password, input):
    ...
    pair_found = False
    if pass_string[0] == pass_string[1]:
        pair_found = True
    elif pass_string[1] == pass_string[2]:
        pair_found = True
    elif pass_string[2] == pass_string[3]:
        pair_found = True
    elif pass_string[3] == pass_string[4]:
        pair_found = True
    elif pass_string[4] == pass_string[5]:
        pair_found = True
    if not pair_found:
        return False
